...
import com.test.base.JavaAppiumBase;

public class AndroidFunctions extends JavaAppiumBase {
	...
	public static void validateAndroidElement(WebElement element, String validationType) {
	...
	public static void windowSwitchNavigateFunctions(String switchAction, String windowHandle, URL newURL,
		...
		case "refresh":
			...
			break;
		case "switchToFrame":
			andDriver.switchTo().frame(frameElement);
			break;
		case "switchToParentFrame":
			andDriver.switchTo().parentFrame();
			break;
		case "openNewWindow":
	...
	public static void cookieStorageFunction(String cookieFunctionType, String deleteCookie, Cookie setCookie) {
		...
		case "setCookie":
			andDriver.manage().addCookie(setCookie);
			break;
		case "getAllCookie":
			Set<Cookie> currentCookies = andDriver.manage().getCookies();
			Stream<Cookie> cookieStream = currentCookies.stream();
			cookieStream.forEach(t -> System.out.println(t));
			break;
		case "deleteCookie":
			andDriver.manage().deleteCookieNamed(deleteCookie);
			break;
